...
{
    internal class CodeBuddyInstallation : CodeEditorInstallation
    {
        protected override string EditorName => "CodeBuddy";
        protected override string ExecutableName => "codebuddy";
        protected override string WindowsExecutablePattern => ".*CodeBuddy.*\\.exe$";
        protected override string macOSAppPattern => ".*CodeBuddy.*\\.app$";
        protected override string LinuxDesktopFileName => "codebuddy.desktop";

        protected override CodeEditorInstallation CreateInstallationInstance() => new CodeBuddyInstallation();
        ...
        {
            return new CodeBuddyInstallation().TryDiscoverInstallationInternal(editorPath, out installation);
        }

        public static IEnumerable<IVisualStudioInstallation> GetInstallations()
        {
            return new CodeBuddyInstallation().GetInstallationsInternal();
        }
